...
python3 tools/export_onnx.py \
    --output-name pretrained_models/yolox_s_cana100_tree_pose.onnx \
    -f exps/default/yolox_s_tree_pose.py \
    -c pretrained_models/2024-03-19_cana100_best.pth

# export onnx file og setup
python3 tools/export_onnx_og.py \
    --output-name pretrained_models/yolox_s_tree_pose_og.onnx \
    -f exps/default/yolox_s_tree_pose.py \
    --task human_pose \
    --export-det \
    -c pretrained_models/2024-03-19_cana100_best.pth
...
python3 kpts_onnx_inference.py \
    --model pretrained_models/yolox_s_cana100_tree_pose_og.onnx \
